      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl">
          ...
          <ConsoleHeading 
            ...
            text={t.hero.title}
            className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-brand-primary tracking-tight leading-tight mb-6"
          />
          <p className="text-lg md:text-xl text-brand-text/80 max-w-2xl mb-10 leading-relaxed">
            {t.hero.desc}
          </p>
